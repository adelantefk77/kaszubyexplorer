...
tabBtns.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    document
      .getElementById("tab-content-hiking")
      .classList.toggle("hidden", tab !== "hiking");
    document
      .getElementById("tab-content-cycling")
      .classList.toggle("hidden", tab !== "cycling");
...
const modalData = {
  ...
  "trail-2": {
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Szimbark_%28k%C3%B2sc%C3%B3%C5%82%29.JPG/960px-Szimbark_%28k%C3%B2sc%C3%B3%C5%82%29.JPG",
  ...
  // PLACES
  "place-skansen": {
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Ko%C5%9Bcierzyna_-_fotopolska.eu_%28192746%29.jpg/960px-Ko%C5%9Bcierzyna_-_fotopolska.eu_%28192746%29.jpg",
  ...
  "lake-wielewskie": {
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/50/Powiat_ko%C5%9Bcierski_035_-_Wiele_-_Jezioro_Wielewskie.JPG/960px-Powiat_ko%C5%9Bcierski_035_-_Wiele_-_Jezioro_Wielewskie.JPG",
  ...
  "rest-2": {
    img: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/B%C4%99domin%2C_Muzeum_Hymnu_Narodowego_%28HB1%29.jpg/960px-B%C4%99domin%2C_Muzeum_Hymnu_Narodowego_%28HB1%29.jpg",
  ...
  "rest-5": {
    img: "https://upload.wikimedia.org/wikipedia/commons/3/33/Wejherowo_miestrium01.jpg",
...
document
  .querySelectorAll(".trail-card, .lake-card, .place-card, .category-card")
  .forEach((el) => {
